...
namespace MVCEmpleados.Controllers
{
    public class EmpleadosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Apellido,Puesto")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Apellido,Puesto")] Empleado empleado)
        {
            if (id != empleado.Id)
            {
                return NotFound();
